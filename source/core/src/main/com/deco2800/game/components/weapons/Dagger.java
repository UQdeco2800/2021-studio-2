 ...
 * shoots a projectile.
 */
// Initial implementation of enemy dagger system - copy from scepter weapon
public class Dagger extends MeleeWeapon {
    ...
    public Dagger(short targetLayer, int attackPower, float knockback, Vector2 weaponSize) {

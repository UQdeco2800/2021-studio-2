...
public class MeleeChaseTask extends ChaseTask implements PriorityTask {
    /**
     ...
     */
    public MeleeChaseTask(Entity target, int priority, float viewDistance, float maxChaseDistance) {
